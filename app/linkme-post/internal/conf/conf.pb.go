...
type Server_GRPC struct {
	...
	Addr        string               `protobuf:"bytes,2,opt,name=addr,proto3" json:"addr,omitempty"`
	Timeout     *durationpb.Duration `protobuf:"bytes,3,opt,name=timeout,proto3" json:"timeout,omitempty"`
	UserService *Server_UserService  `protobuf:"bytes,4,opt,name=userService,proto3" json:"userService,omitempty"`
}
...
func (x *Server_GRPC) GetUserService() *Server_UserService {
	if x != nil {
...
type Server_UserService struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *Server_UserService) Reset() {
	*x = Server_UserService{}
	if protoimpl.UnsafeEnabled {
...
func (x *Server_UserService) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Server_UserService) ProtoMessage() {}

func (x *Server_UserService) ProtoReflect() protoreflect.Message {
	mi := &file_conf_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Server_UserService.ProtoReflect.Descriptor instead.
func (*Server_UserService) Descriptor() ([]byte, []int) {
	return file_conf_proto_rawDescGZIP(), []int{1, 2}
}

func (x *Server_UserService) GetAddr() string {
	if x != nil {
		return x.Addr
	}
	return ""
...
func (x *Server_UserService) GetTimeout() *durationpb.Duration {
	if x != nil {
		return x.Timeout
	}
	return nil
...
var file_conf_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x22, 0xd3, 0x03, 0x0a, 0x06, 0x53, 0x65, 0x72, 0x76,
	...
	0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x1a, 0xab, 0x01, 0x0a, 0x04, 0x47, 0x52, 0x50, 0x43,
	...
	0x6f, 0x75, 0x74, 0x12, 0x40, 0x0a, 0x0b, 0x75, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x6b, 0x72, 0x61, 0x74, 0x6f,
	0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x55, 0x73, 0x65,
	0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x52, 0x0b, 0x75, 0x73, 0x65, 0x72, 0x53, 0x65,
	0x72, 0x76, 0x69, 0x63, 0x65, 0x1a, 0x56, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x61, 0x64, 0x64, 0x72, 0x18, 0x01, 0x20, 0x01,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x52, 0x07, 0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x22, 0xa9, 0x02,
	...
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x1a, 0x35, 0x0a, 0x05, 0x52, 0x65, 0x64, 0x69, 0x73, 0x12, 0x18,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x61, 0x64, 0x64, 0x72, 0x1a, 0x1b, 0x0a, 0x05,
	0x4d, 0x6f, 0x6e, 0x67, 0x6f, 0x12, 0x12, 0x0a, 0x04, 0x61, 0x64, 0x64, 0x72, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x04, 0x61, 0x64, 0x64, 0x72, 0x22, 0x88, 0x01, 0x0a, 0x07, 0x53, 0x65,
	0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x2c, 0x0a, 0x04, 0x65, 0x74, 0x63, 0x64, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x6b, 0x72, 0x61, 0x74, 0x6f, 0x73, 0x2e, 0x61, 0x70, 0x69,
	0x2e, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x45, 0x74, 0x63, 0x64, 0x52, 0x04, 0x65,
	0x74, 0x63, 0x64, 0x1a, 0x4f, 0x0a, 0x04, 0x45, 0x74, 0x63, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x61,
	...
	0x65, 0x6f, 0x75, 0x74, 0x42, 0x20, 0x5a, 0x1e, 0x6c, 0x69, 0x6e, 0x6b, 0x6d, 0x65, 0x2d, 0x70,
...
var file_conf_proto_goTypes = []any{
	...
	(*Server_UserService)(nil),  // 6: kratos.api.Server.UserService
...
var file_conf_proto_depIdxs = []int32{
	...
	10, // 8: kratos.api.Service.etcd:type_name -> kratos.api.Service.Etcd
	...
	6,  // 11: kratos.api.Server.GRPC.userService:type_name -> kratos.api.Server.UserService
	11, // 12: kratos.api.Server.UserService.timeout:type_name -> google.protobuf.Duration
	11, // 13: kratos.api.Service.Etcd.timeout:type_name -> google.protobuf.Duration
...
func file_conf_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_conf_proto_msgTypes[6].Exporter = func(v any, i int) any {
			switch v := v.(*Server_UserService); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
