...
func _Post_GetPostStats0_HTTP_Handler(srv PostHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in GetPostStatsRequest
		if err := ctx.BindQuery(&in); err != nil {
			return err
		}
		http.SetOperation(ctx, OperationPostGetPostStats)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.GetPostStats(ctx, req.(*GetPostStatsRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
...
type PostHTTPClient interface {
	...
	GetPostStats(ctx context.Context, req *GetPostStatsRequest, opts ...http.CallOption) (rsp *GetPostStatsReply, err error)
...
func (c *PostHTTPClientImpl) GetPostStats(ctx context.Context, in *GetPostStatsRequest, opts ...http.CallOption) (*GetPostStatsReply, error) {
