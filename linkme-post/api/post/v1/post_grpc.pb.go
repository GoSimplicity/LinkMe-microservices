...
type PostClient interface {
	...
	GetPostStats(ctx context.Context, in *GetPostStatsRequest, opts ...grpc.CallOption) (*GetPostStatsReply, error)
...
func (c *postClient) GetPostStats(ctx context.Context, in *GetPostStatsRequest, opts ...grpc.CallOption) (*GetPostStatsReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type PostServer interface {
	...
	GetPostStats(context.Context, *GetPostStatsRequest) (*GetPostStatsReply, error)
...
func (UnimplementedPostServer) GetPostStats(context.Context, *GetPostStatsRequest) (*GetPostStatsReply, error) {
...
func _Post_GetPostStats_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PostServer).GetPostStats(ctx, req.(*GetPostStatsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
